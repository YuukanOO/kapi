...
const kapi = (function() {
    ...
    /**
     * Discover plugins in the provided path.
     * 
     * @param {String}  pluginsPath     Path where to require plugins
     */
    Kapi.prototype.discoverPlugins = function(pluginsPath) {
        winston.info(`Discovering plugins at ${pluginsPath}...`);
...
kapi.discoverPlugins(path.join(__dirname, 'plugins'));
